...
export default function TeacherSettingsScreen() {
  ...
  const renderProfileSection = () => (
    <View style={styles.section}>
      ...
      <View style={styles.profileItem}>
        <Text style={styles.profileLabel}>소속학교</Text>
        <Text style={styles.profileValue}>{profileData.school}</Text>
      </View>

      <View style={styles.profileItem}>
        <Text style={styles.profileLabel}>직책</Text>
        <Text style={styles.profileValue}>{profileData.position}</Text>
      </View>

      <View style={styles.profileItem}>
        <Text style={styles.profileLabel}>담당 과목</Text>
    ...
    <View style={styles.section}>
      ...
      <View style={styles.settingItem}>
        ...
        <Switch
          ...
          trackColor={{ false: '#767577', true: '#81c784' }}
          thumbColor={emailNotifications ? '#2196F3' : '#f4f3f4'}
        />
      </View>
      ...
      <View style={styles.settingItem}>
        ...
        <Switch
          ...
          trackColor={{ false: '#767577', true: '#81c784' }}
          thumbColor={smsNotifications ? '#2196F3' : '#f4f3f4'}
        />
      </View>
    </View>
  );
